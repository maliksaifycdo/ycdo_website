...
export default function GalleryNewsletter() {
  ...
  const onSubmit = ({ email }: NewsletterForm) => {
    toast.success(t('footer.subscribedToast', { email }));
    reset();
  };
  ...
  return (
    <section className="relative overflow-hidden bg-[#1A3A8F] py-20">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-8 text-center">
        <h2 className="mb-6 text-3xl font-black tracking-tighter text-white md:text-5xl">{t('gallery.newsletterTitle')}</h2>
